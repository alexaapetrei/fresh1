 ...
 */
const t = "undefined" != typeof window && null != window.customElements &&
...
class r {
  constructor(t, e) {
    ...
    let h = 0, p = -1, c = 0;
    const { strings: u, values: { length: f } } = t;
    for (; c < f;) {
      const t = a.nextNode();
      if (null !== t) {
        if (p++, 1 === t.nodeType) {
          if (t.hasAttributes()) {
            const e = t.attributes, { length: s } = e;
            let i = 0;
          ...
          const e = t.data;
          if (e.indexOf(s) >= 0) {
            const s = t.parentNode, r = e.split(n), a = r.length - 1;
            for (let e = 0; e < a; e++) {
              let i, n = r[e];
              if ("" === n) i = l();
              else {
                const t = d.exec(n);
                null !== t && o(t[2], "$lit$") &&
                (n = n.slice(0, t.index) + t[1] +
                  t[2].slice(0, -"$lit$".length) + t[3]),
...
class y {
  ...
  _clone() {
    ...
    let r, o = 0, l = 0, d = n.nextNode();
    for (; o < i.length;) {
      if (r = i[o], a(r)) {
        for (; l < r.index;) {
          l++,
            "TEMPLATE" === d.nodeName && (s.push(d), n.currentNode = d.content),
            null === (d = n.nextNode()) &&
...
class w {
  ...
  getHTML() {
    ...
    let e = "", n = !1;
    for (let r = 0; r < t; r++) {
      const t = this.strings[r], o = t.lastIndexOf("\x3c!--");
...
class T {
  ...
  __commitText(t) {
    ...
    e === this.endNode.previousSibling && 3 === e.nodeType
      ? e.data = s
      : this.__commitNode(document.createTextNode(s)), this.value = t;
  }
  __commitTemplateResult(t) {
    ...
    if (this.value instanceof y && this.value.template === e) {
      ...
      const s = new y(e, t.processor, this.options), i = s._clone();
...
class N {
  ...
  commit() {
    ...
    (t
      ...
      this.value = t), this.__pendingValue = m;
  }
}
class C extends x {
  constructor(t, e, s) {
...
class k {
  ...
  commit() {
    ...
    const t = this.__pendingValue,
      ...
      s = null == t ||
        null != e &&
          (t.capture !== e.capture || t.once !== e.once ||
            t.passive !== e.passive),
      i = null != t && (null == e || s);
    s &&
 ...
 */
  class {
    handleAttributeExpressions(t, e, s, i) {
      const n = e[0];
      if ("." === n) return new C(t, e.slice(1), s).parts;
...
const I = (t) => (e) => {
    ...
    let n = V.get(i);
    void 0 === n &&
      (n = { stringsArray: new WeakMap(), keyString: new Map() }, V.set(i, n));
    ...
    ((t) => {
      q.forEach((e) => {
        ...
        void 0 !== s && s.keyString.forEach((t) => {
          const { element: { content: e } } = t, s = new Set();
...
class D extends HTMLElement {
  ...
  _propertyToAttribute(t, e, s = H) {
    const i = this.constructor, n = i._attributeNameForProperty(t, s);
    if (void 0 !== n) {
      ...
      s = s || n.getPropertyOptions(t),
        n._valueHasChanged(this[t], e, s.hasChanged)
          ? (this._changedProperties.has(t) ||
            ...
            !0 !== s.reflect || 16 & this._updateState ||
            (void 0 === this._reflectingProperties &&
              (this._reflectingProperties = new Map()),
              this._reflectingProperties.set(t, s)))
          : i = !1;
    }
    !this._hasRequestedUpdate && i &&
...
class Z {
  ...
  get styleSheet() {
    return void 0 === this._styleSheet &&
      (K
...
class tt extends D {
  ...
  static _getUniqueStyles() {
    ...
    this._styles = this._styles.map((t) => {
      if (t instanceof CSSStyleSheet && !K) {
        const e = Array.prototype.slice.call(t.cssRules).reduce(
          (t, e) => t + e.cssText,
          "",
        );
  ...
  initialize() {
    super.initialize(),
      ...
      window.ShadowRoot && this.renderRoot instanceof window.ShadowRoot &&
      this.adoptStyles();
  }
  createRenderRoot() {
  ...
  connectedCallback() {
    super.connectedCallback(),
      this.hasUpdated && void 0 !== window.ShadyCSS &&
...
let st = class extends tt {
    ...
    if (this.swpath && "serviceWorker" in navigator) {
      ...
      if (s.installing && navigator.storage) {
        ...
        if (s) {
          ...
          const i = null === (e = null === (t = this.shadowRoot) || void 0 === t
                  ? void 0
  ...
  doUpdate() {
    ...
    void 0 === e || e.postMessage({ type: this.updateevent }),
      window.location.reload();
  }
  formatBytes(t, e = 2) {
    if (0 === t) return "0 Bytes";
    const s = e < 0 ? 0 : e, i = Math.floor(Math.log(t) / Math.log(1024));
    return parseFloat((t / Math.pow(1024, i)).toFixed(s)) + " " +
      ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"][i];
  }
  render() {
    return B`<div>${
      this.readyToAsk
        ? B`<div id="updateToast" part="updateToast"><span>${this.updatemessage}</span> <button @click="${() =>
